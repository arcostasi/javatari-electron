...
// Copyright 2015-2019 by Paulo Augusto Peccin.

// Main Emulator parameters.
// May be overridden dynamically by URL query parameters,
// if ALLOW_URL_PARAMETERS = true.
...
Javatari = {
    ...
    SCREEN_CRT_MODE:                 3,                         // -1: auto; 0: off; 1: on
    SCREEN_FILTER_MODE:              0,                         // -3: user set (default auto); -2: browser default; -1: auto; 0..3: smoothing level
    SCREEN_DEFAULT_SCALE:            2,                         // -1: auto; 0.5..N in 0.1 steps: scale
    ...
    IMAGES_PATH:                    window.JAVATARI_IMAGES_PATH || "../img/",
    PAGE_BACK_CSS:                  "./css/index.css",                // CSS to modify page background color. Applied to the body element

    WEB_EXTENSIONS_SERVER:          "localhost",     // Server address for NetPlay
